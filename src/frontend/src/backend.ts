...
import type { Booking as _Booking, BookingStatus as _BookingStatus, Category as _Category, ExternalBlob as _ExternalBlob, GalleryCategoryMeta as _GalleryCategoryMeta, Photo as _Photo, UserProfile as _UserProfile, UserRole as _UserRole, Video as _Video, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPhoto(arg0: {
        ...
        if (this.processError) {
            try {
                const result = await this.actor.addPhoto(await to_candid_record_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addVideo(arg0: {
        ...
        if (this.processError) {
            try {
                const result = await this.actor.addVideo(await to_candid_record_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async approveBooking(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async assignPhotographer(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignPhotographer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createSpecialMomentGallery(arg0: {
        title: string;
        date: string;
        description: string;
        photoIds: Array<string>;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.createSpecialMomentGallery(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCategoryMeta(): Promise<Array<[Category, GalleryCategoryMeta]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCategoryMeta();
    ...
    async getAllSpecialMomentGalleries(): Promise<Array<SpecialMomentGallery>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSpecialMomentGalleries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCategoryMeta(arg0: Category): Promise<GalleryCategoryMeta | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCategoryMeta(to_candid_Category_n10(this._uploadFile, this._downloadFile, arg0));
    ...
    async getPackages(arg0: boolean): Promise<Array<Package>> {
        if (this.processError) {
            try {
    ...
    async getPhotosByCategory(arg0: Category): Promise<Array<Photo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotosByCategory(to_candid_Category_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n28(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSitewideContent(): Promise<SitewideContent> {
        if (this.processError) {
            try {
                const result = await this.actor.getSitewideContent();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSpecialMomentGalleriesByDate(arg0: string): Promise<Array<SpecialMomentGallery>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSpecialMomentGalleriesByDate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rejectBooking(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setPhotoFeatured(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setPhotoFeatured(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setVideoFeatured(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setVideoFeatured(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCategoryMeta(arg0: Category, arg1: GalleryCategoryMeta): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCategoryMeta(to_candid_Category_n10(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePackage(arg0: string, arg1: {
        name: string;
        description: string;
        price: bigint;
        isVideo: boolean;
    ...
    async updateSitewideContent(arg0: SitewideContent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSitewideContent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSpecialMomentGallery(arg0: string, arg1: SpecialMomentGallery): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSpecialMomentGallery(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_GalleryCategoryMeta]): GalleryCategoryMeta | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        assignedPhotographer: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.assignedPhotographer)),
...
function from_candid_tuple_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_Category, _GalleryCategoryMeta]): [Category, GalleryCategoryMeta] {
    return [
        from_candid_Category_n22(_uploadFile, _downloadFile, value[0]),
        value[1]
    ];
}
...
function from_candid_variant_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "receptions" in value ? Category.receptions : "weddings" in value ? Category.weddings : "preWedding" in value ? Category.preWedding : value;
}
...
function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_Category, _GalleryCategoryMeta]>): Array<[Category, GalleryCategoryMeta]> {
    return value.map((x)=>from_candid_tuple_n21(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Photo>): Promise<Array<Photo>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Photo_n29(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Video>): Promise<Array<Video>> {
...
async function to_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    title: string;
    blob: ExternalBlob;
    category: Category;
}): Promise<{
    ...
    return {
        title: value.title,
        blob: await to_candid_ExternalBlob_n9(_uploadFile, _downloadFile, value.blob),
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.receptions ? {
        receptions: null
